                        ...
                        <tbody>
                            @forelse ($kriterias as $kriteria)
                                <tr>
                                    ...
                                    <a href="{{ route('kriteria.edit', $kriteria->id) }}" class="btn btn-primary btn-sm d-flex align-items-center">
                                        <i class="fas fa-edit mr-1"></i> Edit
                                    </a>  
                                    <form action="{{ route('ahli.kriteria.destroy', $kriteria->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus?')" style="display:inline">
                                        @csrf
                                        @method('DELETE')
